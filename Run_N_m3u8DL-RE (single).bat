...
:setting_ad_keyword
::设置广告关键词
set user_ad_keyword="o\d{3,4}.ts|/ads?/|dmxleo.dailymotion.com/cdn/manifest/video/|redirector.gvt1.com/api|v12-a.sdn.cz/v_12|stream.highwebmedia.com|doppiocdn|hesads.akamaized.net"
goto :eof
